...
@Component({
  selector: 'app-part15-angular-reactive-form-custom-validator',
  templateUrl: './part15-angular-reactive-form-custom-validator.component.html',
  styleUrls: ['./part15-angular-reactive-form-custom-validator.component.css']
})
export class Part15AngularReactiveFormCustomValidatorComponent implements OnInit {
...
function emailDomain(control: AbstractControl): {[key: string]: any} | null {
  ...
  if(email === '' || domain.toLocaleLowerCase() === 'test.com') {
    return null;
  } else 
  {
