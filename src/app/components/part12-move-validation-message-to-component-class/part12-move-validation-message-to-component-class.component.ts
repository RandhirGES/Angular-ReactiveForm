...
@Component({
  selector: 'app-part12-move-validation-message-to-component-class',
  templateUrl: './part12-move-validation-message-to-component-class.component.html',
  styleUrls: ['./part12-move-validation-message-to-component-class.component.css']
})
export class Part12MoveValidationMessageToComponentClassComponent implements OnInit {
